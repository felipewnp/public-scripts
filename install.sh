...
# Install nat script
wget -q https://raw.githubusercontent.com/felipewnp/public-scripts/nat.sh/nat.sh
...
# Install nat service
wget -q https://raw.githubusercontent.com/felipewnp/public-scripts/nat.sh/nat.service
